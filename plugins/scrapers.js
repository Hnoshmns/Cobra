...
if (config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'song ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
        ...
        var reply = await message.client.sendMessage(message.jid,config.SONG_DOWN + match[1],MessageType.text);
        ...
        ffmpeg(stream)
            ...
            .on('end', async () => {
                ...
                reply = await message.client.sendMessage(message.jid,config.SONG_UP + match[1],MessageType.text);
