...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: Config.ALIVE_CMD, fromMe: true, desc: Lang.ALIVE_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: Config.ALIVE_CMD, fromMe: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
